...
-- Equation(s):
-- \U0|b2v_inst|S~0_combout\ = \Cin~input_o\ $ (\B[0]~input_o\ $ (\A[0]~input_o\))
...
-- Equation(s):
-- \U0|b2v_inst|Cout~0_combout\ = (\Cin~input_o\ & ((\B[0]~input_o\) # (\A[0]~input_o\))) # (!\Cin~input_o\ & (\B[0]~input_o\ & \A[0]~input_o\))
...
-- Equation(s):
-- \U16|b2v_inst|S~combout\ = \B[16]~input_o\ $ (\A[16]~input_o\ $ (\U15|b2v_inst|Cout~0_combout\))
...
PORT MAP (
	dataa => \B[16]~input_o\,
	datab => \A[16]~input_o\,
	datac => \U15|b2v_inst|Cout~0_combout\,
...
-- Equation(s):
-- \U16|b2v_inst|Cout~0_combout\ = (\B[16]~input_o\ & ((\A[16]~input_o\) # (\U15|b2v_inst|Cout~0_combout\))) # (!\B[16]~input_o\ & (\A[16]~input_o\ & \U15|b2v_inst|Cout~0_combout\))
...
-- Equation(s):
-- \U17|b2v_inst|S~combout\ = \A[17]~input_o\ $ (\B[17]~input_o\ $ (\U16|b2v_inst|Cout~0_combout\))
...
PORT MAP (
	datab => \A[17]~input_o\,
	datac => \B[17]~input_o\,
	datad => \U16|b2v_inst|Cout~0_combout\,
	combout => \U17|b2v_inst|S~combout\);

-- Location: LCCOMB_X31_Y1_N6
\U17|b2v_inst|Cout~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \U17|b2v_inst|Cout~0_combout\ = (\A[17]~input_o\ & ((\B[17]~input_o\) # (\U16|b2v_inst|Cout~0_combout\))) # (!\A[17]~input_o\ & (\B[17]~input_o\ & \U16|b2v_inst|Cout~0_combout\))
...
-- Equation(s):
-- \U19|b2v_inst|S~combout\ = \B[19]~input_o\ $ (\U18|b2v_inst|Cout~0_combout\ $ (\A[19]~input_o\))
...
PORT MAP (
	datab => \B[19]~input_o\,
	datac => \U18|b2v_inst|Cout~0_combout\,
	datad => \A[19]~input_o\,
...
-- Equation(s):
-- \U19|b2v_inst|Cout~0_combout\ = (\B[19]~input_o\ & ((\U18|b2v_inst|Cout~0_combout\) # (\A[19]~input_o\))) # (!\B[19]~input_o\ & (\U18|b2v_inst|Cout~0_combout\ & \A[19]~input_o\))
...
-- Equation(s):
-- \U20|b2v_inst|S~combout\ = \A[20]~input_o\ $ (\B[20]~input_o\ $ (\U19|b2v_inst|Cout~0_combout\))
...
PORT MAP (
	dataa => \A[20]~input_o\,
	datab => \B[20]~input_o\,
	datac => \U19|b2v_inst|Cout~0_combout\,
...
-- Equation(s):
-- \U20|b2v_inst|Cout~0_combout\ = (\A[20]~input_o\ & ((\B[20]~input_o\) # (\U19|b2v_inst|Cout~0_combout\))) # (!\A[20]~input_o\ & (\B[20]~input_o\ & \U19|b2v_inst|Cout~0_combout\))
